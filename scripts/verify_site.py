...
HTML_SENTINELS = [
    ...
    "corroborationMatrix",
    "Primary Sources & Single-Source Flags",
    "Action Ledger",
    "actionMatrix",
    "operational control map",
    "Decision Runway",
    "decisionRunway",
    "source-backed next moves",
    "Harness Allocation Ledger",
    "harnessLedger",
    "Experiments, Checkpoints, Budgets",
    "Continuity Map",
    "continuityGrid",
    "Morning Briefing → Afternoon Essay",
    "Open Question Queue",
    "questionQueue",
    "Paper trail for latest record",
    "paperTrail",
    "Cadence Ledger",
    "cadenceLedger",
    "Morning / Afternoon Completeness",
    "Research Velocity",
    "velocityGauge",
    "Freshness & Coverage Gauge",
    "Source Gap Radar",
    "sourceGapRadar",
    "Follow-up Coverage",
    "Coverage Chronicle",
    "coverageChronicle",
    "Archive Depth by Day",
    "Method Triage",
    "triageBoard",
    "What to Trust Next",
    "Citation Workbench",
